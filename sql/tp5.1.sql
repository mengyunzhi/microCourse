...
CREATE TABLE `yunzhi_classroom`  (
  ...
  `classroomplace` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '教室区域',
  `classroomname` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '教室名称',
...
CREATE TABLE `yunzhi_course`  (
  ...
  `term` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '学期',
  `Teacher_id` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '任课教师',
...
CREATE TABLE `yunzhi_courseinfo`  (
  ...
  `week` int(5) NOT NULL,
  `weekday` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `yunzhi_klass`  (
  `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
  `academy` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '学院',
  `major` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '专业',
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '名称',
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_time` int(11) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `yunzhi_student`  (
  ...
  `academy` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '学院',
  `major` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '专业全称',
...
-- ----------------------------
INSERT INTO `yunzhi_student` VALUES (1, '王五', 185555, '123', 1, '人文与法律学院', '法律', 181, 0, 0);
INSERT INTO `yunzhi_student` VALUES (2, '赵六', 184444, '456', 0, '电子信息工程学院', '通信工程', 191, 0, 0);
